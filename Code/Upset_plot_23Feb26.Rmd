...
```{r data_and_setup}
O157 <- read_excel("Data/Genes_139_upset.xlsx")

View(O157) #checking that the correct data is loaded
str(O157) # structure of the variables, seeing that there is the binary 0,1 matrix
...
O157$Site<- factor(O157$Site, levels=c("Farm", "Lairage", "Hide", "Pre-intervention", "Post-intervention"))
...
ggsave(file="Figures/Genes_139_upset_23Feb26.svg", plot=O157_upset, width=12)
